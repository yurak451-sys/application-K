...
import { useAddTransactionViewModel } from '../viewmodels/AddTransactionViewModel';
...
const AddTransactionScreen = ({ onNavigate }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (result.success) {
      ...
      Alert.alert('Упс!', result.error || 'Не удалось добавить транзакцию');
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.section}>
          <Text style={styles.label}>Описание (не обязательно)</Text>
          <TextInput
